...
#new_http_archive(
#  name = "eigen_archive",
#  urls = ["https://mirror.bazel.build/bitbucket.org/eigen/eigen/get/..."],
#  sha256 = "...",
...
foreach(line ${workspace_contents})
    string(REGEX MATCH ".*\"(https://mirror.bazel.build/bitbucket.org/eigen/eigen/get/[^\"]*tar.gz)\"" has_url ${line})
    if(has_url)
